        ...
        <div className="space-y-3">
          {listings.map((listing) => (
            ...
            >
              ...
              <div className="flex h-24">
                ...
                <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
                  <div className="flex-1">
                    <h3 className="font-semibold text-gaming-text-primary text-sm leading-tight line-clamp-1 mb-1">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-base font-bold text-gaming-gold">
              ...
              {/* Mobile Action Buttons - Fixed Height */}
              <div className="flex border-t border-gaming-border h-10">
                <Link href={`/selling/${listing.id}`} className="flex-1">
                  <button className="w-full h-full flex items-center justify-center text-gaming-text-primary hover:bg-gaming-purple/5 hover:text-gaming-purple-light transition-colors text-sm">
                ...
                <button
                  className="flex-1 h-full flex items-center justify-center text-red-400 hover:bg-red-500/5 hover:text-red-300 transition-colors text-sm"
                  onClick={() => {
      ...
      <div className="hidden md:block">
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
          {listings.map((listing) => (
            <div
              key={listing.id}
              className="group relative bg-gaming-bg-card border border-gaming-border rounded-xl overflow-hidden hover:border-gaming-border-light transition-all duration-300 hover:shadow-gaming-lg hover:-translate-y-1 flex flex-col h-full"
            >
              ...
              {/* Desktop Content Container - Flex grow to push buttons down */}
              <div className="p-4 lg:p-5 flex flex-col flex-1">
                <div className="mb-3">
                  <h3 className="font-semibold text-gaming-text-primary text-lg mb-1 line-clamp-2 group-hover:text-gaming-purple-light transition-colors min-h-[3.5rem]">
                    {listing.account_title}
                  </h3>
                ...
                {/* Desktop Action Buttons - Fixed at bottom */}
                <div className="flex gap-2 mt-auto">
                  <Link href={`/selling/${listing.id}`} className="flex-1">
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full h-9 border-gaming-border hover:border-gaming-purple hover:bg-gaming-purple/10 text-gaming-text-primary hover:text-gaming-purple-light"
                    >
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 h-9 border-red-500/30 hover:border-red-500 hover:bg-red-500/10 text-red-400 hover:text-red-300"
                    onClick={() => {
                      setSelectedListingId(listing.id);
                      setShowDialog(true);
                    }}
